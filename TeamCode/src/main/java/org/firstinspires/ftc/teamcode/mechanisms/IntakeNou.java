...
import org.firstinspires.ftc.teamcode.mechanisms.ThreadScheduler;
...
public class IntakeNou implements Runnable {
    ...
    protected ServoImplEx servo180;
    protected ServoImplEx claw;
    protected ServoImplEx servoExtins;
...
//    }
    ...
    public IntakeNou(@NonNull HardwareMap _hardwareMap, LifterEx _lifter) {
    ...
    public void clawSetPosition(long _wait, double _target){
        if (_wait <= 0) {
            ...
            clawThreadScheduler.newThread(new Thread(() -> {
                try {
                    sleep(_wait);
