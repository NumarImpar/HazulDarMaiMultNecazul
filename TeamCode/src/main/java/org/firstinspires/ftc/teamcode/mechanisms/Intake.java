...
public class Intake implements Runnable {
    ...
    public enum INTAKE_STATE {
        INIT(0), INSIDE(-150), OUTSIDE(1450);
        public int ticks;
    ...
    public Intake(@NonNull HardwareMap _hardwareMap) {
    ...
    public void run() {
        ...
        while (!kill) {
            ...
            if (currentTargetTicks != prevTicks && !kill) {
                //motorIntake.setPIDFCoefficients(DcMotor.RunMode.RUN_TO_POSITION, pidfCoefficients);
                ...
                motorIntake.setPower(1.0 * direction);
