...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
      ...
      //myFirstBot.followTrajectorySequence(dreaptaNormal(myFirstBot, initialPoseRedBlueTerminal));
...
//                .splineToSplineHeading(new Pose2d(12, -9, Math.toRadians(90)), Math.toRadians(180))
    ...
    public static TrajectorySequence dreaptaNormal(RoadRunnerBotEntity bot, Pose2d initialPose) {
        ...
        return drive.trajectorySequenceBuilder(initialPose)
                ...
                .splineToSplineHeading(new Pose2d(28.5, -4, Math.toRadians(320)), Math.toRadians(118))
...
//                .setReversed(false)
    ...
    public static TrajectorySequence dreaptaMid(RoadRunnerBotEntity bot, Pose2d initialPose) {
        ...
        return drive.trajectorySequenceBuilder(initialPose)
                ...
                .lineToLinearHeading(new Pose2d(-25.2, -1.6, Math.toRadians(231)))

                .lineToLinearHeading(new Pose2d(-35, -11, Math.toRadians(200)))

                .lineToLinearHeading(new Pose2d(-48, -11.811, Math.toRadians(180)))
